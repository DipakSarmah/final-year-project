...
function Teams() {
  ...
  const { user, showToast, isProjectAllocatedForStudent } = useAppContext()
  ...
  return (
    <div className="flex justify-center items-center flex-col min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="bg-gray-800 p-4 rounded-lg mb-6 shadow-lg flex justify-center items-center flex-col">
        <p className="text-lg font-sans mb-4 text-center text-pretty font-bold text-orange-300">
          Do you want to see your team Details?
        </p>
        <button
          className="bg-blue-500 text-white rounded-lg py-2 px-4 font-semibold hover:bg-blue-600 transition duration-300"
          onClick={() => navigate('/student/teamdetails')}
        >
          Team Detials
        </button>
      </div>
      <div className="bg-gray-800 p-4 rounded-lg mb-6 shadow-lg flex justify-center items-center flex-col">
        ...
        <button
          ...
          disabled={isProjectAllocatedForStudent}
        >
